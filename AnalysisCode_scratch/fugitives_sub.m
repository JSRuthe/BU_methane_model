function [Data_Out] = fugitives_sub(n, j, maxit, Activity, Emissions, EquipGas, EquipOil, Data_Out, Basin_Select, AF_overwrite, AF)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% fugitives component-level model - Emissions calculation subroutine
%
%	Inputs:
%       Input data files for the fugitives model are stored in the
%       "EquipmentDistributions" folder
%	Outputs:
%       Data_Out:
            ...
            % - - - - - - - EQUIPMENT LOOP - - - - - - - - - - - - - - - -
                ...
                if equip_sum(jj) < WellProd
                    ...
                    if Counter2 == maxit
                        ...
                        equip_array(:,jj) = 0;
                        equip_array(idx,jj) = 0.90*WellProd;
                        jj = jj + 1;
                        Counter2 = 1;
                    end
                end
